...
describe('ProductOrder e2e test', () => {
  ...
  const productOrderSample = { placedDate: '2021-12-10T04:42:07.728Z', status: 'COMPLETED', code: 'paradigm Account adapter' };
  ...
  describe('new ProductOrder page', () => {
    ...
    it('should create an instance of ProductOrder', () => {
      cy.get(`[data-cy="placedDate"]`).type('2021-12-10T11:03').should('have.value', '2021-12-10T11:03');
