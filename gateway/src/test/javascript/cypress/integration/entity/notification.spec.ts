...
describe('Notification e2e test', () => {
  ...
  const notificationSample = {
    date: '2021-12-10T08:32:19.480Z',
    sentDate: '2021-12-10T00:45:22.824Z',
    format: 'PARCEL',
    userId: 94565,
    productId: 69326,
  };
  ...
  describe('new Notification page', () => {
    ...
    it('should create an instance of Notification', () => {
      cy.get(`[data-cy="date"]`).type('2021-12-09T16:50').should('have.value', '2021-12-09T16:50');

      cy.get(`[data-cy="details"]`).type('calculate').should('have.value', 'calculate');

      cy.get(`[data-cy="sentDate"]`).type('2021-12-09T16:54').should('have.value', '2021-12-09T16:54');
