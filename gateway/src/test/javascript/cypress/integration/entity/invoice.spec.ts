...
describe('Invoice e2e test', () => {
  ...
  const invoiceSample = {
    date: '2021-12-10T05:14:36.741Z',
    status: 'ISSUED',
    paymentMethod: 'CASH_ON_DELIVERY',
    paymentDate: '2021-12-10T16:13:09.319Z',
    paymentAmount: 75679,
  };
  ...
  describe('new Invoice page', () => {
    ...
    it('should create an instance of Invoice', () => {
      cy.get(`[data-cy="date"]`).type('2021-12-10T06:12').should('have.value', '2021-12-10T06:12');
      ...
      cy.get(`[data-cy="paymentDate"]`).type('2021-12-10T01:29').should('have.value', '2021-12-10T01:29');
