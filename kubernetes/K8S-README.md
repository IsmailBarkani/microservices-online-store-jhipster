...
```
$ docker image tag gateway oncobe/gateway
$ docker push oncobe/gateway
$ docker image tag invoice oncobe/invoice
$ docker push oncobe/invoice
$ docker image tag notification oncobe/notification
$ docker push oncobe/notification
$ docker image tag productorder oncobe/productorder
$ docker push oncobe/productorder
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n mosig
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n mosig
```
...
```
$ kubectl get svc jhipster-prometheus -n mosig
```
...
```
$ kubectl get svc jhipster-grafana -n mosig
```
...
```
$ kubectl expose service jhipster-registry --type=NodePort --name=exposed-registry -n mosig
```

and explore the details using

```
$ kubectl get svc exposed-registry -n mosig
```

For scaling the JHipster registry, use

```
$ kubectl scale statefulset jhipster-registry --replicas 3 -n mosig
```
